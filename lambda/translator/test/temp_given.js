...
exports.generateValidPdsResponseFor = function (nhsNumber) {
        ...
        <soap:Envelope xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/" xmlns:wsa="http://www.w3.org/2005/08/addressing" xmlns:itk="urn:nhs-itk:ns:201005">
            ...
            <soap:Body>
                <itk:DistributionEnvelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
                    <itk:header service="urn:nhs-itk:services:201005:getPatientDetailsByNHSNumber-v1-0Response" trackingid="__INTERNAL_TRACKING_ID__">
                        <itk:auditIdentity>
                            <itk:id type="2.16.840.1.113883.2.1.3.2.4.18.27" uri="urn:nhs-uk:identity:ods:rhm:team1:C"/>
                        </itk:auditIdentity>
                        <itk:manifest count="1">
                            <itk:manifestitem id="uuid_808A9678-49B2-498B-AD75-1D7A0F1262D7" mimetype="text/xml" profileid="urn:nhs-en:profile:getPatientDetailsResponse-v1-0" base64="false" compressed="false" encrypted="false"/>
                        </itk:manifest>
                        <itk:senderAddress uri="urn:nhs-uk:addressing:ods:rhm:team1:C"/>
                    </itk:header>
                    <itk:payloads count="1">
...
exports.generateInvalidPdsResponseFor = function (nhsNumber) {
        return `<?xml version="1.0" encoding="UTF-8"?>
        <!--This example message is provided for illustrative purposes only. It has had no clinical validation. Whilst every effort has been taken to ensure that the examples are consistent with the message specification, where there are conflicts with the written message specification or schema, the specification or schema shall be considered to take precedence-->
        <soap:Envelope xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/" xmlns:wsa="http://www.w3.org/2005/08/addressing" xmlns:itk="urn:nhs-itk:ns:201005">
            <soap:Header>
...
exports.generateValidPdsGetNHSNumberResponseFor = function (nhsNumber) {
        return `<?xml version='1.0' encoding='UTF-8'?>
        <soap:Envelope xmlns:hl7="urn:hl7-org:v3" xmlns:itk="urn:nhs-itk:ns:201005" xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/" xmlns:wsa="http://www.w3.org/2005/08/addressing" xmlns:wsse="http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-secext-1.0.xsd" xmlns:wsu="http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-utility-1.0.xsd" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
            <soap:Header>
                <wsa:MessageID>7EDA70E2-35F1-11E9-9BCC-6C3BE5A861CE</wsa:MessageID>
                <wsa:Action>urn:nhs-itk:services:201005:getNHSNumber-v1-0Response</wsa:Action>
            </soap:Header>
            <soap:Body>
                <itk:DistributionEnvelope>
                    <itk:header service="urn:nhs-itk:services:201005:getNHSNumber-v1-0Response" trackingid="7EDA7452-35F1-11E9-9BCC-6C3BE5A861CE">
                        <itk:manifest count="1">
                            <itk:manifestitem base64="false" compressed="false" encrypted="false" id="uuid_7EBE92FA-35F1-11E9-9BCC-6C3BE5A861CE" mimetype="text/xml" profileid="urn:nhs-en:profile:getNHSNumberResponse-v1-0"/>
                        </itk:manifest>
                    </itk:header>
                    <itk:payloads count="1">
                        <itk:payload id="uuid_7EBE92FA-35F1-11E9-9BCC-6C3BE5A861CE">
                            <getNHSNumberResponse-v1-0 classCode="OBS" moodCode="EVN" xmlns="urn:hl7-org:v3">
                                <id root="7EBE92FA-35F1-11E9-9BCC-6C3BE5A861CE"/>
                                <code code="getNHSNumberResponse-v1-0" codeSystem="2.16.840.1.113883.2.1.3.2.4.17.284"/>
                                <value code="SMSP-0000" codeSystem="2.16.840.1.113883.2.1.3.2.4.17.285"/>
                                <subject typeCode="SBJ">
                                    <patient classCode="PAT">
    ...
    exports.generateInvalidPdsGetNHSNumberResponse = function () {
        return `<soap:Envelope xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/" xmlns:wsa="http://www.w3.org/2005/08/addressing" xmlns:itk="urn:nhs-itk:ns:201005">
            <soap:Body>
                <patient>
                </patient>
            </soap:Body>
